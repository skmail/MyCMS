...
class App_Plugins_Admin_Forms_Grid extends MC_Admin_Form_BaseForm {
    ...
    public function init() {
        ...
        $gridLang = new App_Plugins_Admin_Forms_GridLang();
        ...
        $this->addSubForm(new App_Plugins_Admin_Forms_GirdParams(array('data'=>$data)), 'params');
