...
class Bootstrap extends Zend_Application_Bootstrap_Bootstrap
{
    ...
    protected function _initCustomRoute()
    {
        ...
        $contentsRouter = new Zend_Controller_Router_Route('contents/userdata/images/:crop/:image', array(
                    'module'     => 'frontend',
                    'controller' => 'index',
                    'action'     => 'index',
                    'app'        => 'storage'
        ...
        $frontentApps = new Zend_Controller_Router_Route('index/index/app/items/:category/:item/*', array(
                    'module'     => 'frontend',
                    'controller' => 'index',
                    'action'     => 'index',
                    'app'        => 'items',
        ...
        $router->addRoute('frontentApps', $frontentApps);

        $router->addRoute('contentsRouter', $contentsRouter);
