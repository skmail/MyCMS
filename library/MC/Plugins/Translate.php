...
class MC_Plugins_Translate extends Zend_Controller_Plugin_Abstract
{
    ...
    public function routeShutdown(Zend_Controller_Request_Abstract $request)
    {
        ...
        if ($language !== $locale->getDefault())
        {
            ...
            try
            {
                ...
                $languageClass  =  MC_Core_Loader::appClass('Language','Lang',NULL,'Shared');
                
                $languageVars = $languageClass->setLanguage(array('short_lang'=>$language));
