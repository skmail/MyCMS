 ...
 */
class App_Storage_Shared_Adapter_ImageWorkshop_Core_ImageWorkshopLib
{
    /**
     * @var integer
     */
    ...
    {
        $RGBColors = App_Storage_Shared_Adapter_ImageWorkshop_Core_ImageWorkshopLib::convertHexToRGB($color);
    ...
    public static function getTextBoxDimension($fontSize, $fontAngle, $fontFile, $text)
    {
        if (!file_exists($fontFile)) {
            throw new App_Storage_Shared_Adapter_ImageWorkshop_Core_ImageWorkshopLibException('Can\'t find a font file at this path : "'.$fontFile.'".', static::ERROR_FONT_NOT_FOUND);
        }
