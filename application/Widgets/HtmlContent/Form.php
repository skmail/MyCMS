...
class Widgets_HtmlContent_Form extends MC_Admin_Form_SubForm {
    ...
    public function init() {
        ...
        $templates = $db->select()->from('templates')->join('templates_categories','templates_categories.cat_id=templates.cat_id')->where('parent_template = ?',0);
