...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        fileTemplate: '<li>' +
            ...
            '<span class="qq-upload-full_name"></span>' +
...
qq.extend(qq.FineUploader.prototype, {
    ...
    _onComplete: function(id, fileName, result, xhr){
        ...
        if (result.success){
                ...
                $(this._find(item, 'fileid')).append('<input type="checkbox" name="fileid" value="'+res.results.storage_id+'">');
                $(this._find(item, 'fileid')).append('<input type="hidden" name="destCrop" value="'+res.results.destCrop+'">');
                $(this._find(item, 'fileid')).append('<input type="hidden" name="ext" value="'+res.results.ext+'">');
