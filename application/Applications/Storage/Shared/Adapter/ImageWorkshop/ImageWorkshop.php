 ...
 */
class App_Storage_Shared_Adapter_ImageWorkshop_ImageWorkshop
{
    /**
     * @var integer
     */
    ...
    public static function initFromPath($path)
    {
        ...
        if (file_exists($path) && !is_dir($path)) {
            ...
            switch ($mimeContentType) {
                ...
                default:
                    throw new App_Storage_Shared_Adapter_ImageWorkshop_Exception_ImageWorkshopException('Not an image file (jpeg/png/gif) at "'.$path.'"', static::ERROR_NOT_AN_IMAGE_FILE);
                break;
            }
            return new App_Storage_Shared_Adapter_ImageWorkshop_Core_ImageWorkshopLayer($image);
            throw new App_Storage_Shared_Adapter_ImageWorkshop_Exception_ImageWorkshopException('No such file found at "'.$path.'"', static::ERROR_IMAGE_NOT_FOUND);
        }
    ...
    {
        $textDimensions = App_Storage_Shared_Adapter_ImageWorkshop_Core_ImageWorkshopLib::getTextBoxDimension($fontSize, $textRotation, $fontPath, $text);
    ...
    public static function initVirginLayer($width = 100, $height = 100, $backgroundColor = null)
    {
        ...
        return new App_Storage_Shared_Adapter_ImageWorkshop_Core_ImageWorkshopLayer(App_Storage_Shared_Adapter_ImageWorkshop_Core_ImageWorkshopLib::generateImage($width, $height, $backgroundColor, $opacity));
    }
    ...
    {
        return new App_Storage_Shared_Adapter_ImageWorkshop_Core_ImageWorkshopLayer(imageCreateFromString($imageString));
    }
}